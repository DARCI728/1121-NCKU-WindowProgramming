namespace practice_8 {
    partial class Form1 {
        ...
        private void InitializeComponent() {
            ...
            this.database1DataSet = new practice_8.Database1DataSet();
            this.寶可夢招式BindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.寶可夢_招式TableAdapter = new practice_8.Database1DataSetTableAdapters.寶可夢_招式TableAdapter();
            ...
            this.招式_屬性_威力TableAdapter = new practice_8.Database1DataSetTableAdapters.招式_屬性_威力TableAdapter();
            ...
            this.屬性_克制屬性_被克制屬性TableAdapter = new practice_8.Database1DataSetTableAdapters.屬性_克制屬性_被克制屬性TableAdapter();
            ...
            this.寶可夢招式BindingSource1 = new System.Windows.Forms.BindingSource(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.寶可夢招式BindingSource1)).BeginInit();
            ...
            this.dataGridView1.DataSource = this.寶可夢招式BindingSource1;
            ...
            this.招式屬性威力BindingSource.DataSource = this.bindingSource1;
            // 
            ...
            this.屬性克制屬性被克制屬性BindingSource.DataSource = this.bindingSource1;
            // 
            ...
            // 寶可夢招式BindingSource1
            // 
            this.寶可夢招式BindingSource1.DataMember = "寶可夢_招式";
            this.寶可夢招式BindingSource1.DataSource = this.bindingSource1;
            // 
            // 寶可夢招式招式屬性威力BindingSource
            // 
            this.寶可夢招式招式屬性威力BindingSource.DataMember = "寶可夢_招式_招式_屬性_威力";
            this.寶可夢招式招式屬性威力BindingSource.DataSource = this.寶可夢招式BindingSource1;
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.寶可夢招式BindingSource1)).EndInit();
