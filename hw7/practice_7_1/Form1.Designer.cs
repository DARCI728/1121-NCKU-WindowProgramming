namespace practice_7_1 {
    partial class Form1 {
        ...
        private void InitializeComponent() {
            ...
            // menuStrip
            // 
            menuStrip.Items.AddRange(new ToolStripItem[] { menuFile, menuFunc, toolStripMenuItem3 });
            ...
            // menuFunc
            // 
            menuFunc.DropDownItems.AddRange(new ToolStripItem[] { menu新增單字, menu搜尋單字 });
            menuFunc.Name = "menuFunc";
            menuFunc.Size = new Size(43, 20);
            menuFunc.Text = "功能";
            menuFunc.DropDownItemClicked += toolStripMenuItem2_DropDownItemClicked;
            // 
            // menu新增單字
            // 
            ...
            // toolStripMenuItem3
            // 
            toolStripMenuItem3.DropDownItems.AddRange(new ToolStripItem[] { 字型大小ToolStripMenuItem });
            toolStripMenuItem3.Name = "toolStripMenuItem3";
            toolStripMenuItem3.Size = new Size(43, 20);
            toolStripMenuItem3.Text = "檢視";
